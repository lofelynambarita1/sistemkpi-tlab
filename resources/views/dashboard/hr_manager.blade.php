...
<div class="row mt-4 mb-3 align-items-center">
    <div class="col">
        ...
        <small class="text-muted">Kelola & Review Dokumen KPI Staff · Periode {{ $year }}</small>
    </div>
</div>
...
<div class="card">
    <div class="card-header d-flex align-items-center justify-content-between flex-wrap gap-2">
        ...
        <a href="{{ route('hr.kpi.index') }}" class="btn btn-sm btn-outline-primary">
                        ...
                        <tr>
                            <td>
                                <div class="d-flex align-items-center gap-2">
                                    <div class="avatar-circle-sm">{{ strtoupper(substr($doc->user->name, 0, 2)) }}</div>
                                    <span class="fw-semibold">{{ $doc->user->name }}</span>
                                </div>
                            </td>
                            <td><span class="badge bg-secondary">{{ $doc->user->role_label }}</span></td>
                            <td>{{ $doc->period_year }}</td>
                            ...
                            <td class="text-center">
                                <div class="d-flex justify-content-center gap-1">
                                    ...
                                    <button class="btn btn-sm btn-outline-danger btn-action"
                                            ...
                                            data-delete-desc="Dokumen KPI milik {{ $doc->user->name }} ({{ $doc->period_year }}) akan dihapus."
                                            title="Hapus">
