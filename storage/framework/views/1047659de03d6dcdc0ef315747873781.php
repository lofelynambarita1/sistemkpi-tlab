...
<div class="row mt-4 mb-3 align-items-center">
    ...
    <div class="col-auto">
        <a href="<?php echo e(route('kpi.index')); ?>" class="btn btn-outline-secondary">
        ...
        <div class="form-section-body">
            <div class="row g-3">
                <div class="col-md-3">
                    ...
                    <select name="period_year" class="form-select <?php $__errorArgs = ['period_year'];
                ...
                <div class="form-section-body">
                    ...
                    <div class="table-responsive">
                        <table class="table subform-table table-bordered table-hover">
                            ...
                            <tbody>
                                <?php $__currentLoopData = $masterPerilaku; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        <td><?php echo e($i + 1); ?></td>
                                        <td><span class="fw-semibold"><?php echo e($p['aspek_kinerja']); ?></span></td>
                                        <td><small><?php echo e($p['definisi']); ?></small></td>
                                        <td class="text-center">
                                            
                                            <span class="badge bg-warning text-dark">≥ <?php echo e($p['minimum_capaian_indikator']); ?></span>
                                        </td>
                                        <td>
    <small>
        <?php if(is_array($p['indikator'])): ?>
            <?php $__currentLoopData = $p['indikator']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $level => $text): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div><strong><?php echo e($level); ?>.</strong> <?php echo e(trim($text)); ?></div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        <?php else: ?>
            <?php echo e($p['indikator']); ?>
        ...
        <?php endif; ?>
                                            ...
                                            <input type="number" name="perilaku[<?php echo e($i); ?>][score]"
                                                   ...
                                                   data-min="<?php echo e($p['minimum_capaian_indikator']); ?>">
                                        </td>
                                    </tr>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </tbody>
                            <tfoot>
                                <tr class="table-info">
                                    <td colspan="5" class="text-end fw-bold">Total Score Perilaku:</td>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\New folder (20)\kpi-system\resources\views/kpi/create.blade.php ENDPATH**/ ?>