...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Dashboard'); ?> — Sistem KPI</title>
    <link rel="stylesheet" href="<?php echo e(asset('css/tailwind.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('css/styles.css')); ?>">
    <?php echo $__env->yieldPushContent('styles'); ?>
</head>
<body class="bg-gray-50 <?php echo e(Session::get('dark_mode', false) ? 'dark' : ''); ?>">
        ...
        <nav class="flex-1 px-3 py-4 space-y-1">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(auth()->guard()->check()): ?>
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($role === 'admin'): ?>
                    ...
                    <a href="<?php echo e(route('admin.profile')); ?>" class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm text-white/80 hover:bg-sip-sidebar-sec hover:text-white transition <?php echo e(request()->routeIs('admin.profile') ? 'bg-sip-sidebar-act text-white' : ''); ?>">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"/></svg>
                        Profil Saya
                    </a>
                <?php elseif(in_array($role, ['associate','intermediate','senior','principle'])): ?>
                    <div class="text-[10px] uppercase tracking-wider text-white/40 px-3 pt-4 pb-1">Penilaian KPI</div>
                    <a href="<?php echo e(route('kpi.create')); ?>" class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm text-white/80 hover:bg-sip-sidebar-sec hover:text-white transition <?php echo e(request()->routeIs('kpi.create') ? 'bg-sip-sidebar-act text-white' : ''); ?>">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"/></svg>
                        Form KPI
                    </a>
                    <a href="<?php echo e(route('kpi.index')); ?>" class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm text-white/80 hover:bg-sip-sidebar-sec hover:text-white transition <?php echo e(request()->routeIs('kpi.index') || request()->routeIs('kpi.show') || request()->routeIs('kpi.edit') ? 'bg-sip-sidebar-act text-white' : ''); ?>">
                ...
                <?php elseif($role === 'lead'): ?>
                    ...
                    <a href="<?php echo e(route('lead.review.index')); ?>" class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm text-white/80 hover:bg-sip-sidebar-sec hover:text-white transition <?php echo e(request()->routeIs('review.*') || request()->routeIs('lead.review.*') ? 'bg-sip-sidebar-act text-white' : ''); ?>">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>
                        Review Lead
                    </a>
                    <div class="text-[10px] uppercase tracking-wider text-white/40 px-3 pt-4 pb-1">Akun</div>
                ...
                <?php elseif($role === 'lead_hr'): ?>
                    ...
                    <div class="text-[10px] uppercase tracking-wider text-white/40 px-3 pt-4 pb-1">Review KPI</div>
                    <a href="<?php echo e(route('leadhr.review.index')); ?>" class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm text-white/80 hover:bg-sip-sidebar-sec hover:text-white transition <?php echo e(request()->routeIs('review.*') || request()->routeIs('leadhr.review.*') ? 'bg-sip-sidebar-act text-white' : ''); ?>">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>
                        Review Lead HR
                    </a>
                    <a href="<?php echo e(route('hr.kpi.index')); ?>" class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm text-white/80 hover:bg-sip-sidebar-sec hover:text-white transition <?php echo e(request()->routeIs('hr.kpi*') ? 'bg-sip-sidebar-act text-white' : ''); ?>">
                ...
                <?php elseif($role === 'manager'): ?>
                    <div class="text-[10px] uppercase tracking-wider text-white/40 px-3 pt-4 pb-1">Review KPI</div>
                    <a href="<?php echo e(route('manager.review.index')); ?>" class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm text-white/80 hover:bg-sip-sidebar-sec hover:text-white transition <?php echo e(request()->routeIs('review.*') || request()->routeIs('manager.review.*') ? 'bg-sip-sidebar-act text-white' : ''); ?>">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>
                        Review Manager
                    </a>
                    <a href="<?php echo e(route('hr.kpi.index')); ?>" class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm text-white/80 hover:bg-sip-sidebar-sec hover:text-white transition <?php echo e(request()->routeIs('hr.kpi*') ? 'bg-sip-sidebar-act text-white' : ''); ?>">
...
</html><?php /**PATH D:\New folder (20)\New folder\sistemkpi-tlab\resources\views/layouts/app.blade.php ENDPATH**/ ?>