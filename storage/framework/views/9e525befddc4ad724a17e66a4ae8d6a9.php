...
<body class="bg-gradient min-h-screen flex items-center justify-center">
    <div class="bg-white rounded-2xl shadow-2xl p-8 w-full max-w-md mx-4 text-center">
        ...
        <a href="<?php echo e(route('login')); ?>" class="inline-block bg-red-700 hover:bg-red-800 text-white font-semibold py-2 px-6 rounded-lg transition">
            Kembali ke Login
        </a>
...
<?php /**PATH D:\New folder (20)\New folder\sistemkpi-tlab\resources\views/errors/419.blade.php ENDPATH**/ ?>