<?php $__env->startSection('title', 'Buat Dokumen KPI Baru'); ?>
...
<form method="POST" action="<?php echo e(route('kpi.store')); ?>" id="kpiForm">
    <?php echo csrf_field(); ?>
        ...
        <div class="p-5">
            <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
                <div>
                    ...
                    <select name="period_year" class="form-input <?php $__errorArgs = ['period_year'];
...
unset($__errorArgs, $__bag); ?>" required>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php for($y = date('Y'); $y >= 2020; $y--): ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                        ...
                        <table class="min-w-full divide-y divide-gray-200 subform-table" id="jobdescTable">
                            ...
                            <tbody id="jobdescBody" class="divide-y divide-gray-200">
                                <tr class="jobdesc-row">
                                    <?php echo $__env->make('kpi.partials.jobdesc_row', ['index' => 0, 'row' => null], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                                </tr>
                            </tbody>
                        </table>
                    </div>
                    ...
                    <div class="overflow-x-auto">
                        <table class="min-w-full divide-y divide-gray-200 subform-table" id="ciTable">
                            ...
                            <tbody id="ciBody" class="divide-y divide-gray-200">
                                <tr class="ci-row">
                                    <?php echo $__env->make('kpi.partials.ci_row', ['index' => 0, 'row' => null, 'ciOptions' => $ciOptions], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                                </tr>
                            </tbody>
                        </table>
                    </div>
                    ...
                    <div class="overflow-x-auto">
                        <table class="min-w-full divide-y divide-gray-200 subform-table" id="sdTable">
                            ...
                            <tbody id="sdBody" class="divide-y divide-gray-200">
                                <tr class="sd-row">
                                    <?php echo $__env->make('kpi.partials.sd_row', ['index' => 0, 'row' => null, 'sdOptions' => $sdOptions], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                                </tr>
                            </tbody>
                        </table>
                    </div>
                    ...
                    <div class="overflow-x-auto">
                        <table class="min-w-full divide-y divide-gray-200 subform-table" id="hrTable">
                            ...
                            <tbody id="hrBody" class="divide-y divide-gray-200">
                                <tr class="hr-row">
                                    <?php echo $__env->make('kpi.partials.hr_row', ['index' => 0, 'row' => null, 'hrOptions' => $hrOptions], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                                </tr>
                            </tbody>
                        </table>
                    </div>
                    ...
                    <div class="overflow-x-auto">
                        <table class="min-w-full divide-y divide-gray-200 subform-table">
                            ...
                            <tbody class="divide-y divide-gray-200">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $masterPerilaku; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                    <tr class="hover:bg-gray-50">
                                        <td class="px-3 py-2 text-sm text-gray-500"><?php echo e($i + 1); ?></td>
                                        <td class="px-3 py-2 text-sm font-semibold text-gray-800"><?php echo e($p['aspek_kinerja']); ?></td>
                                        <td class="px-3 py-2 text-xs text-gray-500"><?php echo e($p['definisi']); ?></td>
                                        <td class="px-3 py-2 text-center">
                                            <span class="badge badge-draft text-[10px]">≥ <?php echo e($p['minimum_capaian']); ?></span>
                                        </td>
                                        <td class="px-3 py-2 text-xs text-gray-500"><?php echo e($p['indikator']); ?></td>
                                        <td class="px-3 py-2 text-xs text-gray-500"><?php echo e($p['deskripsi']); ?></td>
                                        <td class="px-3 py-2">
                                            <input type="number" name="perilaku[<?php echo e($i); ?>][score]"
                                                   class="form-input perilaku-score w-20"
                                                   min="0" max="100" step="0.01"
                                                   placeholder="0-100"
                                                   value="<?php echo e(old('perilaku.'.$i.'.score', 0)); ?>"
                                                   data-min="<?php echo e($p['minimum_capaian']); ?>">
                                        </td>
                                    </tr>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\New folder (20)\New folder\sistemkpi-tlab\resources\views/kpi/create.blade.php ENDPATH**/ ?>