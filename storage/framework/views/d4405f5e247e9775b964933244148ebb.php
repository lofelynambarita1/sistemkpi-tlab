...
<div class="bg-white rounded-lg shadow p-6 max-w-2xl">
    <form method="POST" action="<?php echo e(route('admin.users.update', $user)); ?>">
        ...
        <div class="mb-4">
            ...
            <input type="text" id="name" name="name" value="<?php echo e(old('name', $user->name)); ?>" required maxlength="255"
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="mb-4">
            ...
            <input type="email" id="email" name="email" value="<?php echo e(old('email', $user->email)); ?>" required maxlength="255"
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="mb-4">
            ...
            <input type="text" id="jabatan" name="jabatan" value="<?php echo e(old('jabatan', $user->jabatan)); ?>" required maxlength="100"
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="mb-4">
            ...
            <input type="text" id="divisi" name="divisi" value="<?php echo e(old('divisi', $user->department)); ?>" required maxlength="100"
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="mb-4">
            ...
            <select id="atasan_id" name="atasan_id" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-red-700">
                ...
                <option value="<?php echo e($u->id); ?>" <?php echo e(old('atasan_id', $user->atasan_id) == $u->id ? 'selected' : ''); ?>><?php echo e($u->name); ?> (<?php echo e($u->role_label); ?>)</option>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </select>
        </div>
        <div class="mb-4">
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="mb-4">
            ...
            <select id="status_akun" name="status_akun" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-red-700">
                <option value="aktif" <?php echo e(old('status_akun', $user->is_active ? 'aktif' : 'nonaktif') == 'aktif' ? 'selected' : ''); ?>>Aktif</option>
                <option value="nonaktif" <?php echo e(old('status_akun', $user->is_active ? 'aktif' : 'nonaktif') == 'nonaktif' ? 'selected' : ''); ?>>Nonaktif</option>
            </select>
        </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\New folder (20)\New folder\sistemkpi-tlab\resources\views/admin/users/edit.blade.php ENDPATH**/ ?>